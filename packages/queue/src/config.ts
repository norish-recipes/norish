...
export const STALLED_INTERVAL = {
  ...
  [QUEUE_NAMES.PROVENANCE]: 60_000, // 1 min - background enhancement
} as const;
...
export const HANGING_THRESHOLD_MS: Record<QueueName, number> = {
  ...
  [QUEUE_NAMES.PROVENANCE]: 15 * 60_000,
};
...
export const provenanceJobOptions: DefaultJobOptions = {
  attempts: 3,
  backoff: {
    type: "exponential",
    delay: 2000, // 2s, 4s, 8s
