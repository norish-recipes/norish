...
The maintainer confirmed on 2026-09-19 that an ordered list with a marked best guess is welcome in the grocery panel, on the condition below that the Decision never links. The reasoning that made this a question is kept for the record:
