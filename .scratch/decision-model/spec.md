...
- _Duplicate recipes ("same dish?"), ingredient-line headings in flat text, a verification pass over language-model claims._ Genuinely new capabilities Jev is well shaped for. Each needs its own spec; none is required to prove the Decision Model earns its place.
...
| 08  | Recipe Provenance settles country and Cuisines by Decision                         | Later                | needs-triage    |
| 09  | Offered products are ordered by a Decision, never linked by one                    | Later                | needs-triage    |
| 10  | Docs, screenshots and release notes                                                | Ships with 05–07     | ready-for-agent |

02–04 land together as one PR after 01; 05, 06 and 07 are each their own PR with 10 riding the last of them. 08 and 09 wait for a maintainer's word in their comments.
