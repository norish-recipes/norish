# web-recipe-share-management Specification

## Purpose

Define how the Norish web app exposes recipe share-link management to authenticated users and admins, covering the per-recipe bottom panel, the user settings inventory, and the admin settings moderation table.
