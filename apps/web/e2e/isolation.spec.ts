...
import { SECONDARY_RECIPE_NAME } from "./support/api";
import { SECONDARY_USER } from "./support/auth";
import { openOfflineStatus, readBrowserReadCache, warmPrimaryReadCache } from "./support/cache";

test("keeps origin, user, and household read scopes isolated in one browser", async ({
  page,
  context,
}) => {
