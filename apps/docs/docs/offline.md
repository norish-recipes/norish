...
Use **Sync now** after the connection returns. **Retry all** retries Parked or
conflicted work. **Discard all** permanently removes every queued change.
